    ...
    useEffect(() => {
        ...
        if (allPrograms.length < 1)
        {
            ...
            let dummyData = [
                ...
                {department: "Software Development", program: "Certificate", term: "fall", startDate: "September", endDate: "December", legnth: "6 months", description: "This is programming basics", fee: "30,000", code: "23524", courses: [{CourseName: "Sodv", CourseCode: 1101, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Certificate", Description: "Teachers learners the basics of programming using C++", CourseId: 4}, {CourseName: "Tech", CourseCode: 1101, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Certificate", Description: "Teachers learners the fundamentals of web programming.", CourseId: 5}, {CourseName: "Tech", CourseCode: 1102, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Certificate", Description: "Teachers learners the fundamentals of IoT.", CourseId: 6}]},
                {department: "Software Development", program: "Post-Diploma", term: "fall", startDate: "September", endDate: "December", legnth: "6 months", description: "This is programming advanced", fee: "75,000", code: "23525", courses: [{CourseName: "Sodv", CourseCode: 3202, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Post-Diploma", Description: "Teachers learners advanced object oriented architecture", CourseId: 7}, {CourseName: "Data", CourseCode: 3202, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Post-Diploma", Description: "Teachers learners advanced concepts managing databases.", CourseId: 8}, {CourseName: "Sodv", CourseCode: 3201, Term: "Winter", StartDate: "2025-01-05", EndDate: "2025-04-25", Department:"SoftWare Development", Program: "Post-Diploma", Description: "Teachers learners advanced and modern web programming concepts.", CourseId: 9}]},
