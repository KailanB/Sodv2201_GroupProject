        ...
        <div className="unique-page">
            ...
            <form >
                ...
                <div className='form-group'>
                    ...
                    <button className="standardButton deleteButton" onClick={onDeleteCourse}>Delete Course</button>
                    <button className="standardButton cancelButton">Cancel</button>
                    <button className="standardButton saveButton" onClick={() => {onEditCourse(course)} } >Save Changes</button>
                </div>
                </div>
            </form>
        </div>
